        ...
        {items.map((it) => (
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center justify-center size-9 rounded-lg bg-muted hover:bg-muted/70 text-foreground shrink-0 transition-transform duration-150 hover:scale-110 active:scale-90"
            ...
            <button
              ...
              className="p-2 rounded-lg text-muted-foreground hover:bg-muted hover:text-destructive transition-colors duration-150"
              aria-label="Премахни"
            >
              <X className="size-4" />
            </button>
